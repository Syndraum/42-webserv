...
Request::Request() : _response_code(OK)
{}

Request::~Request()
{}

void	Request::print_debug() //TMP
{
...
string	Request::_error_msg(int code)
{
	if (code == BAD_REQUEST)
		return ("Bad Request");
...
int		Request::_return_error(string msg) // msg = TMP
{
	cout << _response_code << " " << _error_msg(_response_code) << " : " << msg << endl;
	return(_response_code);
}

int		Request::_set_method(string line)
{
...
int		Request::_set_path(string line)
{
...
int		Request::_set_version(string line)
{
...
int		Request::_first_line(string line)
{
