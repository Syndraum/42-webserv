			...
			<div class="col-11 col-lg-9">
				...
				<div class="row mt-3">
					<div class="col-9 mb-5">
						...
						<p>
							Les données du formulaire s'affiche si dessous. Observez bien l'url. Il se compose de la ressource, d'un <span class="code-text">?</span>, et d'argument au format <span class="code-text">nom=valeur</span><br>
